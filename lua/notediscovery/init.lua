...
-- Create commands
vim.api.nvim_create_user_command("NoteLogin", function()
  M.login()
end, {})
...
vim.api.nvim_create_user_command("NoteSave", function(opts)
  M.save_note(opts.args)
end, { nargs = "?", complete = "file" })

vim.api.nvim_create_user_command("NoteLoad", function(opts)
  M.load_note(opts.args)
end, { nargs = "?", complete = "file" })

vim.api.nvim_create_user_command("NoteLoadDebug", function(opts)
  M.load_note(opts.args, true)
end, { nargs = "?", complete = "file" })
...
vim.api.nvim_create_user_command("NoteQuick", function()
  M.quick_note()
end, {})

vim.api.nvim_create_user_command("NoteDelete", function(opts)
  M.delete_note(opts.args)
end, { nargs = "?", complete = "file" })
