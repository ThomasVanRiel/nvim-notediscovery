...
command! -nargs=0 NoteTest lua require('notediscovery').test_connection()
...
command! -nargs=? -complete=file NoteLoadDebug lua require('notediscovery').load_note(<q-args>, true)
...
command! -nargs=0 NoteGraph lua require('notediscovery').show_graph()
